...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Ianrnufrkcg3s6>, false, never>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<I5c0hhabdqr8mi>, false, never>;
        /**
    ...
    Referenda: {
         ...
         */
        ReferendumInfoFor: StorageDescriptor<[Key: number], Anonymize<I8tjf5aetgs947>, true, never>;
        /**
    ...
    FellowshipReferenda: {
         ...
         * Information concerning any given referendum.
         */
        ReferendumInfoFor: StorageDescriptor<[Key: number], Anonymize<Iadn4epums2uhi>, true, never>;
        /**
         * The sorted list of referenda ready to be decided but not yet being decided, ordered by
         * conviction-weighted approvals.
         *
    ...
    Scheduler: {
         ...
         */
        Agenda: StorageDescriptor<[Key: number], Anonymize<Ic24had6sj5r04>, false, never>;
        /**
...
type ICalls = {
    ...
    Referenda: {
         ...
         * Emits `Submitted`.
         */
        submit: TxDescriptor<Anonymize<Idnv6pbfffoouj>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I1f8iuvqma6ghn>>;
    };
    Parameters: {
        /**
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ia39eg8v97icpc>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<Iata2r8pmdmcpp>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ia39eg8v97icpc>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I3bmordmnlc8st>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ia39eg8v97icpc>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Ib0mc6ks0sai31>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<Iaf48os65cauaf>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I3bmordmnlc8st>>;
    };
    Society: {
        /**
    ...
    Recovery: {
         ...
         */
        as_recovered: TxDescriptor<Anonymize<Iet8cc3uq0ut5i>>;
        /**
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I41dke7umc2tcn>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I9ocsim46lmpp9>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I23jtcr82a2te1>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I7g9k5thdojl92>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I46rnvi8s2gn3o>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I9f4ab8nblot9r>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Icbko6q5mf2r6m>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I95bsrongsvmjm>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I3nmm2neb03d3i>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Ieqnfrpre3o3vf>>;
    };
    Indices: {
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<Ibcso5pjjfm79c>>;
    };
    Parameters: {
        /**
         * A Parameter was set.
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Ip7g5ah0m1veh>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ifdv6lqa5i8jrl>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I3hkqim5kcum9o>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I5al7n386dk6ks>>;
    };
    Society: {
        /**
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Ic2rsjlctljl78>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I3hkqim5kcum9o>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I32k85km2e8hhj>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<Idqp67nsfe4563>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<I88ku48p2ijoqj>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I9ftc6joheck1g>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I766dsrsdk5kal>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I766dsrsdk5kal>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I8ciua774oe5di>, call: Anonymize<I766dsrsdk5kal>, result_xcms_version: number], Anonymize<If7f1qergdnk31>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Iblcpl72aj79s1>>;
    };
    /**
...
export type KusamaDispatchError = Anonymize<I45cjvlvdsjc1>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KusamaApis = ApisFromDef<IRuntimeCalls>;
...
export type KusamaViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type KusamaCallData = Anonymize<I766dsrsdk5kal> & {
    value: {
        type: string;
    };
};
export type KusamaWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
