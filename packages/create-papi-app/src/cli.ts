...
program
  ...
  .option('-t, --template <template>', 'template to use (minimal, vite-react, next-app, node-cli)')
  .option('-c, --chain <chain>', 'blockchain to connect to (polkadot, kusama, westend, paseo)')
