...
import { useEnhancedClient, fetchMetadata, buildPalletTree, PalletInfo, getNetworkConfig, getProvider } from "@workspace/core"

export function useChainConnection(initialChain = "polkadot", initialProvider = "allnodes-polkadot") {
  ...
  useEffect(() => {
    console.log('Chain connection effect triggered:', { chainStatus, api: !!api, selectedChain })
