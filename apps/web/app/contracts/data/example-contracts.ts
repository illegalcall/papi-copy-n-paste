...
export const EXAMPLE_CONTRACTS: ExampleContract[] = [
  ...
  },
  {
    id: "evm-xcdot",
    name: "xcDOT",
    description: "Polkadot DOT bridged to Moonbeam as an ERC-20 precompile (XC-20). 10 decimals. Verified from Moonbeam XC-20 docs.",
    contractType: "evm",
    chainKey: "moonbeam",
    address: "0xFfFFfFff1FcaCBd218EDc0EbA20Fc2308C778080",
    metadata: ERC20_ABI,
    tags: ["live", "xc20", "bridged"],
  },
  {
    id: "evm-xcusdc",
    name: "xcUSDC",
    description: "USDC bridged from Polkadot Asset Hub to Moonbeam as an ERC-20 precompile. 6 decimals.",
    contractType: "evm",
    chainKey: "moonbeam",
    address: "0xFFfffffF7D2B0B761Af01Ca8e25242976ac0aD7D",
    metadata: ERC20_ABI,
    tags: ["live", "xc20", "stablecoin"],
  },
  {
    id: "evm-xcusdt",
    name: "xcUSDT",
    description: "USDT bridged from Polkadot Asset Hub to Moonbeam as an ERC-20 precompile. 6 decimals.",
    contractType: "evm",
    chainKey: "moonbeam",
